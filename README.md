# SMART AI MARKETING SYSTEM
Developed an AI-powered marketing system that displays top 5 trending products, predicts future trends, and provides budget-based product recommendations using AI APIs.
Built a dynamic dashboard with AI chatbot assistance, customer journey tracking, interactive graphs, and user profiles using React (TypeScript), Node.js, Redis, and MERN stack.

## 🌟Feautres

📊 Interactive Dashboard showing top 5 trending products

🔮 Trend Prediction to identify products that will trend in the next 3 months

🤖 AI Chatbot for product suggestions and marketing guidance

🧭 Customer Journey Tracking to analyze user behavior and engagement

📈 Data Visualization using graphs and charts for insights

💰 Budget-Based Product Recommendations (e.g., products under ₹2000)

🎯 Personalized Product Recommendations using AI logic

👤 User Profile Management for customized experience

🔐 API Key Integration for AI services and secure data access
